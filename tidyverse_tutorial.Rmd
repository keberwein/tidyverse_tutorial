...
We can see by the plot that there is no apparent relationship between batting average and runs scored. However, there seems to be a sample bias based on time period, meaning batting average and runs may not be disjoint events. This behavior suggests we should block our sample by time period in order to isolate the different run scoring environments.
